...
let AudioHeader = (props) => {
  ...
  const handleClose = (privacy) => {
    ...
    var counter=0;
    for(var i=0; i<props.audio.length; i++){  
     counter++;
    }
  
  return (
    <div className="Audio-friends">
...
const mapSTP = (store) => {
  return { audio: store.audioReducer}
}
export default connect(mapSTP)(AudioHeader);